...
// 1. Ordenar en forma descendente: Escribir un programa que ordene un arreglo de enteros en forma descendente 
...
// 2. Búsqueda binaria: Escribir un programa que realice una búsqueda binaria en un arreglo ordenado de enteros 
// utilizando el método Arrays.binarySearch(). El programa debe imprimir el índice del valor buscado si está presente en el arreglo.
...
// 3. Comparar arreglos: Escribir un programa que compare dos arreglos de enteros utilizando el método Arrays.equals(). 
...
// 4. Crear un programa en Java que declare y muestre un arreglo de enteros junto con sus indices. 
// Luego, el programa debe solicitar al usuario dos índices: un índice inicial y un índice final. 
// Con estos dos índices, el programa debe copiar la parte del arreglo original comprendida entre estos dos índices 
// (inclusive) en un nuevo arreglo utilizando el método Arrays.copyOfRange(). 
// Asegúrese de incluir validaciones para confirmar que el índice inicial es menor que el 
// índice final y que ambos índices estén dentro del rango válido del arreglo original. 
...
// 5. Rellenar un arreglo: Escribir un programa que solicite al usuario el tamaño para un arreglo y un entero con el cual quiera rellanarlo, 
...
// 6. Rellenar un arreglo de manera personalizada: Escribir un programa en Java que solicite al usuario un tamaño para un arreglo. 
// Luego, debe pedirle que ingrese un número con el cual desea rellenar cierta parte del arreglo, seguido de un índice final. 
// Esta parte del arreglo deberá ser rellenada con el número proporcionado hasta el indice ingresado por el usuario. 
// Si el índice final ingresado no es el último índice del arreglo, el programa debe continuar pidiendo al usuario nuevos números 
// para rellenar el arreglo, hasta que se haya proporcionado un número para cada posición. Asegúrese de validar lo siguiente:
...
// Cada vez que se solicita un nuevo número para rellenar el arreglo, el índice inicial debe ser el índice 
// inmediatamente siguiente al último índice final ingresado. El usuario solo deberá ingresar el nuevo índice final.
