...
public class myScanner {
  ...
  // 3. Imprime en pantalla un mensaje que diga “Su nombres es [nombre del
  // usuario] y su edad es [edad del usuario]”.
  ...
  // 1. Dados dos números, realizar las 5 operaciones posibles en Java y mostrar
  // el resultado en consola.
  // 2. Pedir al usuario que ingrese dos números, guardarlos en una variable,
  ...
  // 4. Comparar si número 1 es divisible por 2. consideramos divisible si queda
  // un numero entero...
  ...
  public static void operacionesLogicasCombinadas() {
    ...
    if (numero1 > numero2 && numero3 > numero4) {
      System.out.println("El numero1: " + numero1 + " es mayor al numero2: " + numero2 + " y el numero3: " + numero3
          + " es mayor al numero4: " + numero4);
    }
    if (numero1 > numero2 || numero3 > numero4) {
      System.out.println("El numero1: " + numero1 + " es mayor al numero2: " + numero2 + " o si el numero3: " + numero3
          + " es mayor al numero4: " + numero4);
    }
    scanner.close();
  ...
  // 2. Declarar variables para almacenar los números y el resultado de la
  // operación
