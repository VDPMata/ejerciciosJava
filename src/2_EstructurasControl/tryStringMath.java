...
public class tryStringMath {
    ...
    // dos números enteros y realice la división del primer número entre el segundo
    // número.
    // Utiliza un bloque "try-catch" para manejar la excepción en caso de que se
    // intente realizar
    // una división por cero. En caso de que se produzca la excepción, muestra un
    ...
    // al usuario
    // una cadena de caracteres que represente un número entero. Utiliza el método
    // Integer.parseInt()
    // para convertir la cadena a un número entero. Utiliza un bloque "try-catch"
    // para manejar la excepción
    // en caso de que la cadena ingresada no pueda ser convertida a un número
    // entero. En caso de que se produzca
    ...
    // una cadena de texto
    // y muestre en pantalla la longitud de la cadena utilizando el método length()
    // de la clase String.
    ...
    // usuario su
    // nombre y apellido por separado, y luego muestre en pantalla el nombre
    // completo utilizando
    ...
    // usuario una
    // frase y dos números enteros, representando un índice inicial y un índice
    // final.
    // Utilizar el método substring() de la clase String para extraer la subcadena
    // que se encuentra
    // entre los índices ingresados por el usuario, y mostrar la subcadena
    ...
    // usuario
    // una palabra y un carácter, y determine si el carácter ingresado se encuentra
    // en la palabra
    // utilizando el método indexOf() de la clase String. Mostrar un mensaje
    ...
    // solicite al usuario
    // una cadena de texto y muestre en pantalla la misma cadena, pero con todos los
    // caracteres
    // en mayúsculas o minúsculas. Utilizar los métodos toUpperCase() y
    // toLowerCase()
    ...
    // usuario un número decimal y muestre
    // en pantalla su valor redondeado utilizando el método round() de la clase
    // Math.
    ...
    // genere y muestre en pantalla un número
    // aleatorio en el rango del 1 al 100 utilizando el método random() de la clase
    // Math. Puedes utilizar el método floor()
    ...
    // usuario dos números enteros,
    // representando la base y el exponente, y calcular el resultado de elevar la
    // base al exponente utilizando el método pow()
    ...
    // usuario un número positivo y calcule
    // su raíz cuadrada utilizando el método sqrt() de la clase Math. Si el número
    // ingresado es negativo, mostrar un mensaje adecuado en pantalla.
