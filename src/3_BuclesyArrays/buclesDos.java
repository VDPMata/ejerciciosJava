...
public class buclesDos {
    ...
    // Contar ocurrencias: Escribir un programa que recorra un array de caracteres y
    // solicite al usuario un carácter objetivo,
    // y cuente cuántas veces aparece el carácter objetivo en el array y lo imprima
    // por consola.
    ...
    // Calcular promedio: Sumar todos los elementos de un array de números reales y
    ...
    // en una sola cadena separada por espacios e imprimirlo
    // en consola.
    ...
    // Menú interactivo con while: Crea un menú interactivo que solicite al usuario
    // que elija una opción de un conjunto de opciones.
    // El menú debe seguir apareciendo hasta que el usuario elija la opción para
    // salir del programa. Para este ejercicio,
    // no es necesario que las opciones del menú realicen acciones reales. Solo
    // necesitas mostrar un mensaje que indique qué
    ...
    // 1 y 100, y le pida al usuario
    // adivinar ese número utilizando un bucle do-while. El programa debe mostrar un
    // mensaje indicando si el número
    // ingresado es mayor o menor que el número aleatorio, y continuar pidiendo al
    // usuario que adivine hasta que lo haga correctamente.
    ...
    // ingresar una contraseña y la valide utilizando un bucle while.
    // La contraseña correcta es "secreto". El programa debe seguir pidiendo al
    // usuario que ingrese la contraseña hasta que sea correcta.
    ...
    // entero y utilice un bucle while para calcular
    // el número de dígitos de ese número. Por ejemplo, el número 4578 tiene 4
    // dígitos
    // (pensar en la lógica para el 0 que debe devolver que tiene una cifra y
